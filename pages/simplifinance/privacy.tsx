	...
	return (
		<div className={styles.container}>
			...
			<main className={styles.main}>
				<h1 className={styles.title}>Simplifinance Policy</h1>
				<strong>Privacy Policy</strong>
				<p>
					Corliansa Kusumah built the Simplifinance app as an Open Source app.
					This SERVICE is provided by Corliansa Kusumah at no cost and is
				...
				<p>
					...
					Terms and Conditions, which are accessible at Simplifinance unless
				...
				<p>This policy is effective as of 2022-04-16</p>
				<p>
					<strong>Contact Us</strong>
				</p>
				<p>
					If you have any questions or suggestions about my Privacy Policy, do
					not hesitate to contact me at corliansa@gmail.com.
				</p>
			</main>
		</div>
	);
