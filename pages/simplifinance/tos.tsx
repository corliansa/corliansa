	...
	return (
		<div className={styles.container}>
			...
			<main className={styles.main}>
				<h1 className={styles.title}>Simplifinance TOS</h1>
				...
				<p>
					...
					security features and it could mean that the Simplifinance app won’t
				...
				<p>
					...
					can’t turn it on to avail the Service, Corliansa Kusumah cannot accept
					responsibility.
				</p>
				<p>
					With respect to Corliansa Kusumah’s responsibility for your use of the
					...
					that we can make it available to you. Corliansa Kusumah accepts no
				...
				<p>
					...
					the updates if you want to keep using the app. Corliansa Kusumah does
					not promise that it will always update the app so that it is relevant
					to you and/or works with the Android &amp; iOS version that you have
