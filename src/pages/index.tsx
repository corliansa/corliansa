    ...
    <>
      ...
      <Base>
        ...
        <p className="my-6 text-lg leading-8 text-gray-400 sm:text-center">
          I&apos;m Corliansa, a computer science graduate from <a href="https://tu.berlin/" target="_blank" rel="noreferrer">Technische Universität Berlin</a>. I am currently working at <a href="https://telli.com/" target="_blank" rel="noreferrer">telli</a>.
        </p>
